...
import org.usfirst.frc.team766.robot.commands.Elevator.Presets.MoveElevatorBottom;
...
public class Auton_MoveToLandfill extends CommandGroup {
    ...
    public  Auton_MoveToLandfill() {
    	...
    	addParallel(new MoveElevatorBottom());//Replace with whatever preset is used to pick up a box on the ground
